    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <div className="relative bg-dark-100 border border-light-100/10 p-8 rounded-3xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <p className="text-light-200 text-center mb-8">
          {isLogin ? 'Log in to join watch parties' : 'Sign up to start watching with friends'}
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {!isLogin && (
            <div>
              <label className="block text-xs font-bold text-light-200 uppercase tracking-widest mb-1.5 ml-1">Full Name</label>
              <input
                type="text"
                value={name}
          ...
          <div>
            <label className="block text-xs font-bold text-light-200 uppercase tracking-widest mb-1.5 ml-1">Email Address</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-xs font-bold text-light-200 uppercase tracking-widest mb-1.5 ml-1">Password</label>
            <input
              type="password"
              value={password}
